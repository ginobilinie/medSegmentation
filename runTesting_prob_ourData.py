...
#parser.add_argument("--modelPath", default="/shenlab/lab_stor5/dongnie/Seg3D_wce_wdice_viewExp_resEnhance_0224_ourData_45000.pt", type=str, help="prefix of the to-be-saved model name")
#parser.add_argument("--prefixPredictedFN", default="Seg3D_wdice_wce_viewExp_resEnhance_iter50000_0224_ourData", type=str, help="prefix of the to-be-saved predicted filename")
parser.add_argument("--modelPath", default="/shenlab/lab_stor5/dongnie/Seg3D_wce_wdice_viewExp_resEnhance_fullAd_0224_ourData_45000.pt", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="Seg3D_wdice_wce_viewExp_resEnhance_iter45000_fullAD_0224_ourData", type=str, help="prefix of the to-be-saved predicted filename")
