...
parser.add_argument("--lambdaAD", type=float, default=1, help="loss coefficient for AD loss. Default=0.1")
...
parser.add_argument("--resume", default="/shenlab/lab_stor5/dongnie/challengeData/modelFiles/SegCha_3D_wce_wdice_viewExp_resEnhance_lrdcr_0110_140000.pt", type=str, help="Path to checkpoint (default: none)")
...
parser.add_argument("--prefixModelName", default="/shenlab/lab_stor5/dongnie/challengeData/modelFiles/SegCha_3D_wce_wdice_viewExp_resEnhance_lrdcr_0110_", type=str, help="prefix of the to-be-saved model name")
...
'''
def showTestStatistics(netG, lossG_G, loss_dice, lossG_D, lossG_focal, lossG_contour, lossG_Reg, lossD, iter, labeled=True):
...
#     running_loss = 0.0
    ...
    #             print 'prob: ',averProb
                ...
                if opt.isNetDFullyConv:       
                    lossG_D_ADV = opt.lambdaAD * criterion_BCEND(outputD, real_label) #note, for generator, the label for outputG is real
                else:
