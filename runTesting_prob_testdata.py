...
parser.add_argument("--modelPath", default="/shenlab/lab_stor/dongnie/challengeData/modelFiles/SegCha_3D_GenDice_wce0p5_lr2e3_lrdce_viewExp_DS_Dp_HR_SEUNet_0817_100000.pt", type=str, help="prefix of the to-be-saved model name")
...
#parser.add_argument("--modelPath", default="/shenlab/lab_stor/dongnie/challengeData/modelFiles/SegCha_3D_onlyGeneDice_viewExp_HR_0427_45000.pt", type=str, help="prefix of the to-be-saved model name")
#parser.add_argument("--modelPath", default="/shenlab/lab_stor/dongnie/challengeData/modelFiles/SegCha_3D_geneDice_wce_viewExp_HR_0427_70000.pt", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="model0817_10w_", type=str, help="prefix of the to-be-saved predicted filename")
...
#parser.add_argument("--prefixPredictedFN", default="preTestCha_model0110_iter14w_ROI_", type=str, help="prefix of the to-be-saved predicted filename")
