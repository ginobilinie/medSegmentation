...
# parser.add_argument("--modelPath", default="/shenlab/lab_stor/dongnie/challengeData/modelFiles/SegCha_3D_onlyGenDice_lr2e3_lrdce_viewExp_DS_Dp_HR_0728_100000.pt", type=str, help="prefix of the to-be-saved model name")
