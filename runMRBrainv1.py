...
parser.add_argument("--input_sz", type=arg_as_list, default=[16, 144, 144], help="the input patch size of list")
parser.add_argument("--output_sz", type=arg_as_list, default=[16, 144, 144], help="the output patch size of list")
parser.add_argument("--test_step_sz", type=arg_as_list, default=[8, 16, 16],
...
parser.add_argument("--iter_size", type=int, default=6,
...
parser.add_argument("--prefixModelName", default="/shenlab/lab_stor5/dongnie/MRBRAIN18/modelFiles/SegMRBrain144_3D_GeneDice_WCE_lr5e3_lrdce_viewExp_Dp_UNet_1029_", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="preSub1_MRBrain144_3D_GeneDice_WCE_lr5e3_lrdce_viewExp_DS_Dp_UNet_1029_", type=str, help="prefix of the to-be-saved predicted filename")
...
parser.add_argument("--path_patients_h5", default='/shenlab/lab_stor5/dongnie/MRBRAIN18/h5data_snorm_144/h5data_train/', type=str, help="the path for the training hdf5 files")
parser.add_argument("--path_patients_h5_test", default='/shenlab/lab_stor5/dongnie/MRBRAIN18/h5data_snorm_144/h5data_val/', type=str, help="the path for the testing hdf5 files")
