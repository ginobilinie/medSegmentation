...
parser.add_argument("--prefixModelName", default="/home/dongnie/myPytorchCodes/pytorch-SRResNet23D/SegCha_3D_wce_wdice_viewExp_resEnhance_lrdcr_fullAd_1231_", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="preSub45_cha_3D_wce_wdice_viewExp_resEhance_lrdcr_fullAd_1231_", type=str, help="prefix of the to-be-saved predicted filename")
