...
parser.add_argument("--in_channels", type=int, default=2, help="the input channels ?")
...
parser.add_argument("--prefixModelName", default="/shenlab/lab_stor/dongnie/challengeData/modelFiles/SegCha_3D_onlyGenDice_viewExp_HR_ACM_0426_", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="preSub45_cha_3D_onlyGenDice_viewExp_HR_ACM_0426_", type=str, help="prefix of the to-be-saved predicted filename")

parser.add_argument("--test_input_file_acm_name",default='/shenlab/lab_stor5/dongnie/challengeData/res_traindata/preCha_wce_wdice_viewExp_resEhance_fullAD_0110_iter14w_sub45.nii.gz',type=str, help="the input file name for testing subject")
...
parser.add_argument("--path_patients_h5",default='/shenlab/lab_stor5/dongnie/challengeData/proCha3D_acm',type=str, help="the path for the training hdf5 files")
parser.add_argument("--path_patients_h5_test",default='/shenlab/lab_stor5/dongnie/challengeData/proCha3D_acm_test',type=str, help="the path for the testing hdf5 files")
parser.add_argument("--path_patients_unlabeled_h5",default='/shenlab/lab_stor5/dongnie/challengeData/proCha3D_acm',type=str, help="the path for the training unlabeled hdf5 files")
...
#         matFA = mrnp[:,y1:y2,x1:x2] #note, matFA and matFAOut same size 
        matFA = input[:,:,y1:y2,x1:x2] #note, matFA and matFAOut same size 
