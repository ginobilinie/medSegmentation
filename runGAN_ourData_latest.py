...
parser.add_argument("--in_channels_netD", type=int, default=7, help="the input channels for netD?")
parser.add_argument("--out_channels_netD", type=int, default=2, help="the output channels for netD?")
parser.add_argument("--given_weight", type=arg_as_list, default=[1,1,4,4], help="the given weight for each organ (bg included)")
...
parser.add_argument("--isSemanticGuidance", action="store_true", help="Do we use semantic guidance for shallow layer feature learning?", default=True)
...
parser.add_argument("--lambdaAD", type=float, default=0.5, help="loss coefficient for AD loss. Default=0.1")
...
parser.add_argument("--iter_size", type=int, default=2, help="number of iterations(actually, it is batches) to update the network parameters")
...
parser.add_argument("--prefixModelName", default="/shenlab/lab_stor5/dongnie/pelvic/models/SegOurData_2p5D_geneDice_mce_lr2e3_lrdceLimit_viewExp_ResSeg_DS_SemGuided_fullAD_lambda0p5_0513_", type=str, help="prefix of the to-be-saved model name")
parser.add_argument("--prefixPredictedFN", default="preSub1_ourData_2p5D_geneDice_mce_lr2e3_lrdceLimit_viewExp_ResSeg_DS_SemGuided_fullAD_lambda0p5_0513_", type=str, help="prefix of the to-be-saved predicted filename")
...
parser.add_argument("--path_patients_h5",default='/shenlab/lab_stor5/dongnie/pelvic/pelvicSegRegContourBatchH5',type=str, help="the path for the training hdf5 files")
parser.add_argument("--path_patients_h5_test",default='/shenlab/lab_stor5/dongnie/pelvic/pelvicSegRegContourH5Test',type=str, help="the path for the testing hdf5 files")
