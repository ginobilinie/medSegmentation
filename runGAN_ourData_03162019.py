...
parser.add_argument("--gpuID",default='0',type=str, help="the GPU ID")
...
parser.add_argument("--prefixModelName", default="/home/dongnie/Desktop/myPyTorch/pytorch-SRResNet23D/SegPelvic_2p5D_geneDice_mce_lr2e3_lrdce_viewExp_UNet_0312_", type=str, help="prefix of the to-be-saved model name")
...
parser.add_argument("--prefixPredictedFN", default="preSub1_segPelvic_2p5D_geneDice_mce_lr2e3_lrdce_viewExp_UNet_0312_", type=str, help="prefix of the to-be-saved predicted filename")
